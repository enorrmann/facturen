...
public class Reporte {
    ...
    public static JasperPrint getLibroIvaCompras() {
        ...
        /* 37 */ Map<String, Object> parametros = new HashMap<>(); // Mapa de parámetros tipado correctamente
        ...
        try {
            /* 39 */ impresion = JasperFillManager.fillReport(
                    /* 40 */ getReportInputStream("IvaCompras"), parametros,
                    (JRDataSource) new JRBeanCollectionDataSource(filasReporte));
        }
    ...
    public static JasperPrint getResumenDgr() {
        ...
        try {
            /* 56 */ impresion = JasperFillManager.fillReport(
                    /* 57 */ getReportInputStream("ResumenDGR2"), parametros,
                    (JRDataSource) new JRBeanCollectionDataSource(filasReporte));
        }
    ...
    private static InputStream getReportInputStream(String reportName) {
        /* 66 */ return Reporte.class.getClassLoader()
                .getResourceAsStream("org/solidstate/facturen/reporting/" + reportName + ".jasper");
    }
    ...
    public static JasperPrint getLibroIvaVentas() {
        ...
        try {
            ...
            /* 115 */ impresion = JasperFillManager.fillReport(is, parametros, ds);
 ...
 * facturen/reporting/Reporte.class
